...
Repeat for the recommended amount of repetitions. (bodybuilding.com)";
        $exercise->description_hu = "Félkörívben emeld fel a rudat a karjaid behajlításával addig, míg a bicepszed el nem éri a csúcsösszehúzódás pontját. Figyelj rá hogy olyan pozícióban fejezd be a mozgást, amikor a bicepsz még dolgozik - ha túl magasra emeled a súlyt, azzal tehermentesítheted a célizmot. A könyöködet tartsd a testedhez minél közelebb, és lehetőleg mozdulatlanul. (bodybuilder.hu)";
...
Continue alternating in this manner for the recommended amount of repetitions. (bodybuilding.com)";
        $exercise->description_hu = "Ha lehet, könyöködet egy helyben tartva, lassan és egyenletesen emeld az egyik súlyzót a válladhoz. Ereszd vissza, és a másik karral is ismételd a mozdulatot. Ügyelj rá, hogy a könyököd ne mozogjon ki oldalra. Végezheted egyszerre a két karoddal is a gyakorlatot. (bodybuilder.hu)";
        $exercise->musclegroup_id = "2";
        $exercise->exercisetype_id = "2";
...
When you are done, place the bar back in the rack. (bodybuilding.com)";
        $exercise->description_hu = "Biztosítva, hogy felkar a törzstől oldalirányban kifelé mozogjon, lassan hajlítsd be karodat és ereszd lefelé a rudat, míg az meg nem érinti a mellkasod közepét, a mellbimbók vonalában. Nyomd vissza a kiinduló helyzetbe, és ismételd a mozgást az edzéstervedben meghatározott ismétlésszám szerint. (bodybuilder.hu)";
...
Hold for a second at the starting position and repeat the movement for the prescribed amount of repetitions. (bodybuilding.com)";
        $exercise->description_hu = "Húzd le a karjaidat a melled vagy a csípőd elé, majd kontrolláltan engedd vissza őket, a mellizom teljes megnyúlásáig. Próbáld meg az izommunkát egész idő alatt a mellizomzatra koncentrálni. Amikot összehúztad a két fogantyút, tudatosan feszíts rá a mellizmokra. (bodybuilder.hu)";
        $exercise->musclegroup_id = "3";
        $exercise->exercisetype_id = "2";
...
Repeat for the recommended amount of repetitions. (bodybuilding.com)";
        $exercise->description_hu = "Nyomd egyenesen fel a súlyzót az arcod előtt, egészen addig, míg a karod kiegyenesedik, és a súlyzó közvetlenül a fejed fölött van. Lassan engedd vissza a kiinduló helyzetbe a súlyzót, és ismételd meg a mozgást az előírt ismétlésszámmal. (bodybuilder.hu)";
...
Continue all the way down, keeping the weight on the front of the heel. At the moment the upper legs contact the lower legs reverse the motion, driving the weight upward. (bodybuilding.com)";
...
Repeat for the recommended amount of repetitions. (bodybuilding.com)";
        $exercise->description_hu = "Lassan hajlítsd vállát a térded felé, annyira, hogy lapockáid 3-5 cm-re eltávolodjanak a padlótól. Tarts ki így egy másodpercig, majd ereszkedj vissza a kiinduló helyzetbe és ismételj. (bodybuilder.hu)";
...
Slowly begin to bring the bar back to starting position as your breathe in.
Repeat for the recommended amount of repetitions. (bodybuilding.com)";
        $exercise->description_hu = "Ha lehet, könyöködet egy helyben tartva, lassan és egyenletesen emeld a súlyzót válladhoz. Ereszd vissza, és ismételd a mozdulatot. (bodybuilder.hu)";
